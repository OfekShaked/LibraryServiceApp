...
using LibraryRenewal.DAL.Repositories;
...
using LibraryRenewal.DAL.Converters;
...
namespace LibraryRenewal.BLL.Services
{
    public class GeneralLibraryLogic : IGeneralLibraryLogic
    {
        ...
        ILibraryDbContext _libraryDbContext;
        IUserConverter _userConverter;
        IBookConverter _bookConverter;
        IJournalConverter _journalConverter;
        IGenreConverter _genreConverter;
        ...
        public GeneralLibraryLogic()
        {
            ...
            _journalConverter = new JournalConverter(_libraryDbContext);
            _genreConverter = new GenreConverter();
            _abstractItemConverter = new AbstractItemConverter(_libraryDbContext,_genreConverter);
            _saleConverter = new SaleConverter();
            _userRep = new UserRepository(_libraryDbContext,_userConverter);
            _saleRep = new SaleRepository(_libraryDbContext,_saleConverter);
            _saleService = new SaleService(_saleRep);
            _genreRep = new GenreRepository(_libraryDbContext,_genreConverter);
        ...
        public GeneralLibraryLogic(ILibraryDbContext context, IUserRepository userRep, IGenreRepository genreRep, IGeneralRepository generalRep, IBookRepository bookRep, IJournalRepository journalRep, ISaleRepository saleRep)
        {
